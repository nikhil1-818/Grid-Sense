...
function AuthPage() {
  ...
  const sendOtp = async () => {
    if (!phone) return toast.error("Enter phone with country code, e.g. +14155551234");
    setLoading(true);
    try {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 aurora-bg bg-background">
      <div className="w-full max-w-md">
        <Link to="/" className="flex items-center justify-center gap-2 mb-6">
          ...
          <span className="font-semibold text-lg tracking-tight">GridSense AI</span>
        </Link>

        <div className="glass rounded-2xl p-6 border border-border/60">
          <h1 className="text-xl font-semibold tracking-tight">Sign in to GridSense</h1>
          <p className="text-sm text-muted-foreground mt-1">
            Access enterprise electricity intelligence.
          </p>
